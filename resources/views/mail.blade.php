                ...
                <tr>
                    <td class="esd-stripe" align="center">
                        <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0" cellspacing="0"
                            width="600" style="border-radius: 20px 20px 0 0 ">
                            <tbody>
                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td align="left" class="esd-block-text es-p20">
                                                                        <h3>Welcome, Gold Manager</h3>
                                                                        <p><br></p>
                                                                        <p>You're receiving this message
                                                                            because you recently signed
                                                                            up for a
                                                                            account.<br><br>Confirm your
                                                                            email address by clicking
                                                                            the button below. This step
                                                                            adds extra security to your
                                                                            business by verifying you
                                                                            own this email.</p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="esd-block-button">
                                                                        <span class="msohide es-button-border"
                                                                            style="display: block; background: #7630f3;"><a
                                                                                href class="es-button msohide"
                                                                                target="_blank"
                                                                                style="padding-left: 5px; padding-right: 5px; display: block; background: #7630f3; mso-border-alt: 10px solid  #7630f3">Confirm
                                                                                email</a></span>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                ...
                <tr>
                    <td class="esd-stripe" align="center">
                        <table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0"
                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-structure es-p20t es-p20b es-p40r es-p40l esdev-adapt-off"
                                        align="left">
                                                ...
                                                <tr>
                                                    <td class="esdev-mso-td" valign="top">
                                                        <table cellpadding="0" cellspacing="0" align="left"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td width="47" class="esd-container-frame"
                                                    ...
                                                    <td class="esdev-mso-td" valign="top">
                                                        <table cellpadding="0" cellspacing="0" class="es-right"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td width="453" class="esd-container-frame"
                                                                        align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%">
                                                                            <tbody>
